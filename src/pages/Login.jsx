...
export default function Login() {
  ...
  return (
    <div className="flex bg-transparent items-center justify-center min-h-screen p-4">

      <div className="w-full max-w-md   p-10 text-white">
        {/* Branding */}
       <div className="login-desc mb-10">
         <h1 className="text-4xl font-extrabold text-center text-blue-200 mb-2 tracking-wide mb-4">
          SmartEduX
        </h1>
